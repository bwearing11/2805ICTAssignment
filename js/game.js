...
var gameSpeeds = [1000, 600, 300];//controls the falling speed
...
var gameSize = [6, 10, 16] 
var sizeSelector = 0   
var gameSizeWidth = 0; //stores the gamefield size 
var gameSizeHeight = 20;// height of the field
...
var fieldCords = [250,175] //size and position of the field based on inputted gamefield size
...
var level = 0
var levelName = ['Easy', "Medium", "Hard" ] // level of the game, can be changed in the settings menu
var linesCleared = 0; // keeps track of lines cleared by player
    
var pieceStartPoint = 0
...
var scoretext, currentPlayer, leveltext, linetext, gametypetext, modetext, timedEvent, currentTetromino,nextPiece, controls, nextPieceImage, currentPiece; // a list of variables that are required to be global but don't need values at game start 
...
var rotation1 ={ //matrix positions after the first rotation
    ...
    7 : [[0,0],[1,0],[0,1]], // small L
    8 : [[0,0],[1,0],[-1,0]] //small straight    
...
var blockTextures = [ //list of block textures, has the same index as the positional matrices for ease of use
    ...
    'leftzigblock', 'smalllblock', 'shortstraightblock'
]
var singleBlockTextures = [
    'singleleftlblock', 'singlerightlblock', 'singlestraightblock',
    'singlesquareblock','singlerightzigblock', 'singletblock',
    'singleleftzigblock', 'singleleftlblock', 'singlestraightblock'
]
...
highScores = [["ZOE", '20000'],["ZUN", '18500'],["AAA", '17000'], ["AAA", '0'], ["AAA", '0'], ["AAA", '0'], ["AAA", '0'], ["AAA", '0'], ["AAA", '0'], ["AAA", '0']]

var gameline1,gameline2,gameline3, gameline4, gameline5, gameline6, gameline7, gameline8,
gameline9, gameline10, gameline11, gameline12, gameline13, gameline14,gameline15,gameline16, gameline17, gameline18, gameline19, gameline20, gameline21,
gameline22, gameline23, gameline24
